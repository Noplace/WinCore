/****************************************************************************
    Khalid's Standard Library "ks"
    Copyright © 2008 
    By Khalid Ali Al-Kooheji
    Filename    : template.h
    Namespace   : ks::delegate::{Variable Namespace}
    Description : template include file that will generate the 
                  delegation functions for different number of parameters
****************************************************************************/
namespace core {
